# -*- coding: utf-8 -*-
"""
Created on Thu Mar 23 20:12:04 2017
...
'''This works; however when the matrix x is very large,
 ...
 of v vertically, then performing elementwise summation of x and vv. 
...
actually creating multiple copies of v. Consider this version, 
using broadcasting:'''
...
If the arrays do not have the same rank, prepend the shape of the lower rank 
array with 1s until both shapes have the same length.

The two arrays are said to be compatible in a dimension if they have the same 
